...
fn calc_expected_means(data: &Array2<i32>) -> Array1<f64> {
    ...
    // Use BFGS method
    let result = minimize(|means| cost_function(data, &means.to_owned(), &normal), &x0, Method::BFGS, Some(opts))
...
fn main() {
    println!("Hello, world!");
    let data = array![[0, 0, 0, 0, 0, 0, 0, 0, 13, 0], [20, 0, 0, 0, 0, 14, 0, 1, 20, 5], [20, 20, 0, 14, 13, 20, 8, 20, 20, 20], [20, 20, 6, 0, 7, 20, 3, 19, 20, 20], [20, 20, 7, 13, 0, 20, 4, 19, 20, 20], [20, 6, 0, 0, 0, 0, 0, 8, 20, 8], [20, 20, 12, 17, 16, 20, 0, 20, 20, 20], [20, 19, 0, 1, 1, 12, 0, 0, 20, 13], [7, 0, 0, 0, 0, 0, 0, 0, 0, 0], [20, 15, 0, 0, 0, 12, 0, 7, 20, 0]];
